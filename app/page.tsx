  ...
  return (
    <div className='container'>
      <div className=' flex flex-row'>
        ...
        <div className='basis-1/2'>
          <ViewingThreads imgXPos={imgXPos} imgYPos={imgYPos} imgScale={imgScale} image={image} setNailSequence={setNailSequence} startManualThreading={startManualThreading} controlType={controlType} nailSequenseIndex={nailSequenseIndex} />
        </div>
      </div>
      <div className='flex flex-row'>
        <div className='basis-full'>
          <ManualViewing nailSequence={nailSequence} setStartManualThreading={setStartManualThreading} setControlType={setControlType} setNailSequenseIndex={setNailSequenseIndex} />
        </div>
      </div>
    </div>
  );
