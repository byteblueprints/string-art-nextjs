                ...
                <div className="container mx-auto flex items-center justify-center space-x-12 py-4">
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex space-x-6">
                            <a href="https://linkedin.com/in/yourprofile" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
                            ...
                            <a href="https://twitter.com/yourprofile" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
                            ...
                            <a href="https://instagram.com/yourprofile" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
                            ...
                            <a href="https://facebook.com/yourprofile" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
                            ...
                            <a href="https://youtube.com/yourchannel" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex space-x-6">
                            <a href="https://www.buymeacoffee.com/yourprofile" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
                            ...
                            <a href="https://patreon.com/yourprofile" target="_blank" rel="noopener noreferrer" className="group hover:scale-110 transition-transform">
